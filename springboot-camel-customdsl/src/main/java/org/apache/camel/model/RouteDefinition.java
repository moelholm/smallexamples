...
public class RouteDefinition<T extends RouteDefinition<T>> extends ProcessorDefinition<T> {
     ...
     * @return the builder
     */
    public T routeDescription(String description) {
     ...
     * @return the builder
     */
    public T startupOrder(int order) {
